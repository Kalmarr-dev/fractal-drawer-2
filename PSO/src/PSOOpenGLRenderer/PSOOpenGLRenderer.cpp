...
template<typename T>
PSOOpenGLRenderer<T>::PSOOpenGLRenderer(
  PSODataProvider<T>* p_data_provider, ICamera<T>* p_camera,
...
template<typename T>
void PSOOpenGLRenderer<T>::render_to_screen() {
  base_renderer->render_to_screen();
}

template<typename T>
void PSOOpenGLRenderer<T>::render_shapes_to_screen() {
  base_renderer->render_shapes_to_screen();
}

template<typename T>
void PSOOpenGLRenderer<T>::clear_screen() {
  base_renderer->clear_screen();
}

template<typename T>
void PSOOpenGLRenderer<T>::process_window_resize(int width, int height) {
  base_renderer->process_window_resize(width, height);
}

template<typename T>
void PSOOpenGLRenderer<T>::process_window_reconstruction(IViewport* p_viewport) {
  base_renderer->process_window_reconstruction(p_viewport);
}

template<typename T>
void PSOOpenGLRenderer<T>::render_pso_to_screen() {
  ...
  Shapes<T> shapes = p_data_provider->get_pso_history(&colors);
