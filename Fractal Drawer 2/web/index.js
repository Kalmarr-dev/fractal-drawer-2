...
Module['FS_createPath']("/res", "shaders", true, true);
    ...
    loadPackage({"files": [{"filename": "/res/config.txt", "start": 0, "end": 493}, {"filename": "/res/shaders/basic.shader", "start": 493, "end": 1243}, {"filename": "/res/shaders/colored.shader", "start": 1243, "end": 1764}, {"filename": "/res/shaders/colored_depth.shader", "start": 1764, "end": 2295}, {"filename": "/res/shaders/colored_depth_webgl2.shader", "start": 2295, "end": 2870}, {"filename": "/res/shaders/colored_webgl2.shader", "start": 2870, "end": 3433}, {"filename": "/res/shaders/monochrome.shader", "start": 3433, "end": 3861}, {"filename": "/res/shaders/repeat_fractal.shader", "start": 3861, "end": 4575}], "remote_package_size": 4575});

  })();

// end include: /tmp/tmp4uibfctu.js
// include: /tmp/tmplqbbm4vp.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmplqbbm4vp.js
// include: /tmp/tmp726tbrh6.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp726tbrh6.js
