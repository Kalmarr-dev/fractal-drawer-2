...
Module['FS_createPath']("/res", "shaders", true, true);
    ...
    loadPackage({"files": [{"filename": "/res/config.txt", "start": 0, "end": 493}, {"filename": "/res/shaders/basic.shader", "start": 493, "end": 1243}, {"filename": "/res/shaders/colored.shader", "start": 1243, "end": 1764}, {"filename": "/res/shaders/colored_depth.shader", "start": 1764, "end": 2295}, {"filename": "/res/shaders/colored_depth_webgl2.shader", "start": 2295, "end": 2870}, {"filename": "/res/shaders/monochrome.shader", "start": 2870, "end": 3298}, {"filename": "/res/shaders/repeat_fractal.shader", "start": 3298, "end": 4012}], "remote_package_size": 4012});

  })();

// end include: /tmp/tmpzdzhnd0y.js
// include: /tmp/tmpwfr7o5hc.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpwfr7o5hc.js
// include: /tmp/tmpze38jhz6.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpze38jhz6.js
